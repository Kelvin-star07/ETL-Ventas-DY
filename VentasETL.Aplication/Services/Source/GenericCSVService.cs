...
{
    public class GenericCSVService<Tentity,TentityDto> : IGenericCSVService<TentityDto> where TentityDto : class, new() where Tentity : class, new()
    {
        
        
        private readonly IGenericReadFileRepository<Tentity> _repository;
        private readonly string Path;

        public GenericCSVService(IGenericReadFileRepository<Tentity> repository, string path)
        {
        ...
        {
            var entities = await _repository.ReadFile(Path);
